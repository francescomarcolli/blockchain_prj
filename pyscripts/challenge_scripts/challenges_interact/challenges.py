...
fss_trading_account = web3.eth.account.from_key(private_key=fss_private_key)
local_account_trading = LocalAccount(fss_account.address, fss_account, fss_account.privateKey)
## Admin account
fss_admin_private_key = "ede4dd8a3584fd7809a5e0bb299ff8f51983af5b1a9f1f506165b5c1f09e22b1"
fss__admin_account = web3.eth.account.from_key(private_key=fss_private_key)
local_account_admin = LocalAccount(fss_account.address, fss_account, fss_account.privateKey)
